...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() =>
      getByText(appointment, "Unable to save please try again")
    );

    // 9. Check that the error message has appeared.
    expect(
      getByText(appointment, "Unable to save please try again")
    ).toBeInTheDocument();
  });
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    await waitForElement(() =>
      getByText(appointment, "Unable to delete please try again")
    );

    // 8. Check that the error message has appeared.
    expect(
      getByText(appointment, "Unable to delete please try again")
    ).toBeInTheDocument();
  });
